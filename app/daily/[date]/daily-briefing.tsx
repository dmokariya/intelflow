...
export default function DailyBriefing({ date }: { date: string }) {
  ...
  return <main className="daily-post">
    <header><Link className="daily-logo" href="/"><span>IF</span><strong>IntelFlow</strong></Link><Link href="/daily">Daily archive</Link></header>
    <article>
      ...
      <footer><strong>Context, not advice.</strong><p>IntelFlow automatically condenses attributed source material. It does not provide investment recommendations. Verify important information with the original publisher.</p><Link href="/">Personalise your IntelFlow briefing →</Link></footer>
    </article>
  </main>;
}
