...
const allowed = new Set(["session_started","signed_in","story_viewed","story_saved","story_unsaved","storyarc_opened","source_opened","share_started","share_completed","share_downloaded","feed_refreshed","topic_opened","scroll_feedback","profile_updated","signed_out","account_deleted"]);
