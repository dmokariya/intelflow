...
export default function Disclosure() {
  return <LegalLayout kicker="EDITORIAL TRANSPARENCY" title="News & summary disclosure">
    ...
    <h2>How briefs are produced</h2><p>The system uses automated methods to select and condense important sentences. Automated processing can still produce incomplete or awkward results, so the linked original article is the authoritative reference.</p>
